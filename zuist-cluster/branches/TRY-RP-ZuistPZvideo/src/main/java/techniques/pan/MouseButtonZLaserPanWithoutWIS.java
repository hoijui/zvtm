 ...
 *
 */
public class MouseButtonZLaserPanWithoutWIS extends AbstractPanTechnique {
	 ...
	 * @param o
	 */
	public MouseButtonZLaserPanWithoutWIS(String id, ORDER o) {
		...
		pointedScreen = new PointedScreen("WILDDefault.conf");
...
//							vz = ((Float)parts[5]).floatValue();
							...
							if ( ((Float)parts[7]).floatValue() < 0 ) { // VY.y
								coordinates = pointedScreen.computeProjectedCoordinates(x, y, z, vx, vy, vz);
							} else {
								coordinates = pointedScreen.computeProjectedCoordinates(x, y, z, v2x, v2y, v2z);
							}
