...
class ViewerEventHandler implements ViewListener, ComponentListener, CameraListener, PickerListener {
    ...
    public void Kpress(ViewPanel v,char c,int code,int mod, KeyEvent e){
        ...
        else if (code==KeyEvent.VK_W){application.translateView(Viewer.MOVE_SLOW_UP);}
        else if (code==KeyEvent.VK_S){application.translateView(Viewer.MOVE_SLOW_DOWN);}
        else if (code==KeyEvent.VK_A){application.translateView(Viewer.MOVE_SLOW_LEFT);}
        else if (code==KeyEvent.VK_D){application.translateView(Viewer.MOVE_SLOW_RIGHT);}
