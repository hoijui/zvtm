...
#JARS=$JARS":target/"
JARS=$JARS":target/javaSmarties-1.3.0.jar"
JARS=$JARS":target/zuist-cluster-0.3.0-SNAPSHOT.jar"

java -Djava.net.preferIPv4Stack=true -Djgroups.bind_addr=$IP -Xmx1024M -cp $JARS fr.inria.zuist.cluster.aviewer.Viewer -r 4 -c 6 -bw 2020 -bh 1180 "$@"
