...
public class MenuManager {
    ...
    static final String[] navMenuItems = {UISTExplorer.NAV_MODE_DEFAULT_STR, UISTExplorer.NAV_MODE_FISHEYE_STR, UISTExplorer.NAV_MODE_FISHEYE2_STR, UISTExplorer.NAV_MODE_SS_STR};
    VRectangleST[] navMenuItemBoxes = new VRectangleST[navMenuItems.length];
    VText[] navMenuItemLabels = new VText[navMenuItems.length];
    
    MenuManager(UISTExplorer app){
    ...
    void initMenu(){
        ...
        breadcrumbsBox = new VRectangleST(0, 0, 0, (UISTExplorer.VIEW_MAX_W-MENU_ZONE_WIDTH)/2, UP_BT_HEIGHT,
            MENU_FILL_COLOR, MENU_BORDER_COLOR, MENU_TRANSLUCENCE);
