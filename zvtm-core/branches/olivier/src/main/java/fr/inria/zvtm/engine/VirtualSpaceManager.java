...
public class VirtualSpaceManager implements AWTEventListener {
    ...
    /** */
    public int stackPortalFront(Portal p){
        View v = p.getOwningView();
        return v.stackPortalFront(p);
    }

    /** */
    public int stackPortalBack(Portal p){
        View v = p.getOwningView();
        return v.stackPortalBack(p);
    }

    /** */
    public int stackPortalAtIndex(Portal p, int index){
        View v = p.getOwningView();
        return v.stackPortalAtIndex(p, index);
    }
