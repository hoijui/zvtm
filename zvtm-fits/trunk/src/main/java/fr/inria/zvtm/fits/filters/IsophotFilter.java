...
public class IsophotFilter extends RGBImageFilter implements ColorGradient {
    ...
    static {
        ...
        map[5] = new Color(.00000f, .00000f, .23530f);
        map[6] = new Color(.00000f, .00000f, .31760f);
        map[7] = new Color(.00000f, .00000f, .39610f);
        map[8] = new Color(.00000f, .00000f, .47450f);
        map[9] = new Color(.00000f, .00000f, .55690f);
        map[10] = new Color(.00000f, .00000f, .63530f);
        map[11] = new Color(.00000f, .00000f, .71760f);
        map[12] = new Color(1.00000f, 1.00000f, 1.00000f);
        ...
        map[45] = new Color(.00000f, 1.00000f, .65490f);
        map[46] = new Color(.00000f, 1.00000f, .56080f);
        map[47] = new Color(.00000f, 1.00000f, .46670f);
        map[48] = new Color(.00000f, 1.00000f, .37250f);
        map[49] = new Color(1.00000f, 1.00000f, 1.00000f);
        map[50] = new Color(1.00000f, 1.00000f, 1.00000f);
        ...
        map[62] = new Color(1.00000f, 1.00000f, 1.00000f);
        ...
        map[70] = new Color(.99220f, .88630f, .00000f);
        map[71] = new Color(.99220f, .85100f, .00000f);
        map[72] = new Color(.98820f, .81570f, .00000f);
        map[73] = new Color(.98820f, .77650f, .00000f);
        map[74] = new Color(1.00000f, 1.00000f, 1.00000f);
        map[75] = new Color(1.00000f, 1.00000f, 1.00000f);
        map[76] = new Color(.98820f, .67060f, .00000f);
        map[77] = new Color(.98820f, .63920f, .00000f);
        map[78] = new Color(.99220f, .60390f, .00000f);
        map[79] = new Color(.99220f, .56860f, .00000f);
        map[80] = new Color(.99610f, .53730f, .00000f);
        map[81] = new Color(.99610f, .50200f, .00000f);
        map[82] = new Color(1.00000f, .47060f, .00000f);
        map[83] = new Color(1.00000f, .40390f, .00000f);
        map[84] = new Color(1.00000f, .34120f, .00000f);
        map[85] = new Color(1.00000f, .27840f, .00000f);
        ...
        map[99] = new Color(1.00000f, 1.00000f, 1.00000f);
        map[100] = new Color(1.00000f, 1.00000f, 1.00000f);
        ...
        map[114] = new Color(1.00000f, .21180f, 1.00000f);
