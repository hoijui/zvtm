 ...
 *
 * $Id: MainEventHandler.java 2899 2010-02-11 10:02:28Z epietrig $
 */
...
class MainEventHandler implements ViewEventHandler, ComponentListener, PortalEventHandler {
    ...
    static double ZOOM_SPEED_COEF = 1.0/50.0;
    static double PAN_SPEED_COEF = 50.0;
    static final double WHEEL_ZOOMIN_COEF = 21.0;
    static final double WHEEL_ZOOMOUT_COEF = 22.0;
    static double WHEEL_MM_STEP = 1.0;
    ...
    MainEventHandler(FITSViewer app){
