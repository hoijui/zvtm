 ...
 *
 *  (c) COPYRIGHT INRIA (Institut National de Recherche en Informatique et en Automatique), 2012-2015.
 ...
 */
public class VSegmentExample {
	//shortcut
	private VirtualSpaceManager vsm = VirtualSpaceManager.INSTANCE;

	VSegmentExample(VSegmentOptions options){
		vsm.setMaster("VSegmentExample");
        ...
        VSegment segment = new VSegment(0,0,2,2,0,Color.WHITE);
        vs.addGlyph(segment);
        segment.setEndPoints(0,0,20,20);
        segment.orientTo(40);
    }

	public static void main(String[] args){
		VSegmentOptions options = new VSegmentOptions();
