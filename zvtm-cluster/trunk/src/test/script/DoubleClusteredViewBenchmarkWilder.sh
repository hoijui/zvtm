...
java -Djgroups.bind_addr="192.168.2.2" -Djava.net.preferIPv4Stack=true -cp "$CLASSPATH:../../../target/*" $CLASSNAME -d --glyph-number 500 --block-width 960 --block-height 960 --num-rows 5 --num-cols 15"$@" 
