...
/**Profile: gaussian - Distance metric: L(2) (circular shape)<br>Size expressed as an absolute value in pixels. Parameterable focus offset.*/

public class FSOGaussianLens extends FSGaussianLens implements ParameterableFocusOffset {
    
    /**
     * create a lens with a maximum magnification factor of 2.0
     */
    public FSOGaussianLens(){
     ...
     */
    public FSOGaussianLens(float mm){
	    this(mm, 100, 50, 0, 0);
    }
     ...
     */
    public FSOGaussianLens(float mm, int outerRadius, int innerRadius){
	    this(2.0f, outerRadius, innerRadius, 0, 0);
    }
     ...
     */
    public FSOGaussianLens(float mm, int outerRadius, int innerRadius, int x, int y){
