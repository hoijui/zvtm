...
public class L3TLinearLens extends TLinearLens {

    /**
     * create a lens with a maximum magnification factor of 2.0
     */
    public L3TLinearLens(){
	super();
    }
     ...
     */
    public L3TLinearLens(float mm, float tc, float tf, int outerRadius, int innerRadius){
     ...
     */
    public L3TLinearLens(float mm, float tc, float tf, int outerRadius, int innerRadius, int x, int y){
