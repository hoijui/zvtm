...
public class VTriangleOr extends VTriangle {
    ...
    /**
        ...
        */
    public VTriangleOr(double x,double y, int z,double s,Color c,double or){
    ...
    /**
        ...
        */
    public VTriangleOr(double x, double y, int z, double s, Color c, Color bc, double or, float alpha){
        super(x, y, z, s, c, bc);
        orient = or;
    }
    ...
    public Object clone(){
        VTriangleOr res = new VTriangleOr(vx, vy, 0, vs, color, borderColor, orient, (alphaC != null) ? alphaC.getAlpha() : 1f);
