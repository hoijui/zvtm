...
public class Utilities {
    ...
    /** 
     *get the Java AWT color which correpsonds to a color keyword as defined in <a href="http://www.w3.org/TR/SVG/types.html#ColorKeywords">http://www.w3.org/TR/SVG/types.html#ColorKeywords</a>
	...
	if (colorsByKeyword==null){//init table if this is the first time we access it
