...
ssh wild@c1.wild.lri.fr -o UserKnownHostsFile=/dev/null -o Stricwild@c1.wild.lri.fr "export DISPLAY=:0.1 && cd /home/wild/romain/zvtm_tc && mvn -DactiveNodes=slave4 -DstartServer=false  tc:run" &
ssh wild@c1.wild.lri.fr -o UserKnownHostsFile=/dev/null -o Stricwild@c2.wild.lri.fr "export DISPLAY=:0.0 && cd /home/wild/romain/zvtm_tc && mvn -DactiveNodes=slave1 -DstartServer=false  tc:run" &
ssh wild@c1.wild.lri.fr -o UserKnownHostsFile=/dev/null -o Stricwild@c2.wild.lri.fr "export DISPLAY=:0.1 && cd /home/wild/romain/zvtm_tc && mvn -DactiveNodes=slave5 -DstartServer=false  tc:run" &
ssh wild@c1.wild.lri.fr -o UserKnownHostsFile=/dev/null -o Stricwild@c3.wild.lri.fr "export DISPLAY=:0.0 && cd /home/wild/romain/zvtm_tc && mvn -DactiveNodes=slave2 -DstartServer=false  tc:run" &
ssh wild@c1.wild.lri.fr -o UserKnownHostsFile=/dev/null -o Stricwild@c3.wild.lri.fr "export DISPLAY=:0.1 && cd /home/wild/romain/zvtm_tc && mvn -DactiveNodes=slave6 -DstartServer=false  tc:run" &
ssh wild@c1.wild.lri.fr -o UserKnownHostsFile=/dev/null -o Stricwild@c4.wild.lri.fr "export DISPLAY=:0.0 && cd /home/wild/romain/zvtm_tc && mvn -DactiveNodes=slave3 -DstartServer=false  tc:run" &
ssh wild@c1.wild.lri.fr -o UserKnownHostsFile=/dev/null -o Stricwild@c4.wild.lri.fr "export DISPLAY=:0.1 && cd /home/wild/romain/zvtm_tc && mvn -DactiveNodes=slave7 -DstartServer=false  tc:run" &
