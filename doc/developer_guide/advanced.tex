...
<dependency>
  ...
  <version>0.2.1</version> <!-- or any newer version -->
</dependency>
\end{SaveVerbatim}
\fbox{\BUseVerbatim[boxwidth=0.99\columnwidth]{CodeVerb}}
...
for (int i = 0; i < document.getNumberOfPages(); i++) {
    IcePDFPageImg g = new IcePDFPageImg(i*Math.round(page_width*1.1f*detailFactor), 0, 0,
...
<dependency>
  ...
  <version>0.1.1</version> <!-- or any newer version -->
</dependency>
\end{SaveVerbatim}
\fbox{\BUseVerbatim[boxwidth=0.99\columnwidth]{CodeVerb}}
