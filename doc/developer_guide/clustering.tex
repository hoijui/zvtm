...
\begin{itemize}
\item
  \verb! VirtualSpaceManager.setMaster() !
\item
  \verb! VirtualSpaceManager.addClusteredView() !
\item
  \verb! VirtualSpaceManager.stop() !
\item
  \verb! ClusterGeometry ! class 
\item
  \verb! ClusteredView ! class 
\item
  \verb! ClusteredImage ! class 
\item
  \verb! ClusteredStroke ! class 
\end{itemize}
