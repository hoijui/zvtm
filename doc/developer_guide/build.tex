...
\hline
ZVTM Cluster & \cd{zvtm-cluster} & Run ZVTM applications on clusters of computers driving high-resolution large displays such as the WILD \surl{http://insitu.lri.fr/Projects/WILD} or ANDES \surl{http://www.inria.cl/?page_id=2727\&amp;lang=en} wall-sized displays & \ref{sec:clustering} \\
\hline
ZVTM Agile2D & \cd{zvtm-agile2d} & Rendering ZVTM views using the Agile2D OpenGL-backed Java2D implementation & \ref{sec:agile2d} \\
\hline
