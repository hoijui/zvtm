...
There are two main types of views \cl{com.xerox.VTM.engine.View}: external views \cl{EView, GLEView}, which are managed by the windowing system, e.g., Mac OS X, Windows, X11/Xorg; panel views \cl{PView}\footnote{Formerly miscalled AppletView because it was used mostly within a Swing JApplet.}, which can be inserted in any Swing hierarchy.
