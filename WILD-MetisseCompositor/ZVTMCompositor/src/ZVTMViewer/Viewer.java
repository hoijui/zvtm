...
public class Viewer {
	...
	public long repaintMinDelay = 10;//the view will refresh as soon as a framebuffer update come, but it will wait at least repaintMinDelay milis
	...
	private void initTimer() {
		...
		time.scheduleAtFixedRate(t, 0, repaintMinDelay);
	}
	...
	public void addFrame(MetisseWindow f){
		
		mSpace.addGlyph(f);
	//	System.out.println("frame added to the virtual space");
	}
	
	public void remFrame(MetisseWindow f){
		
		mSpace.removeGlyph(f);
	//	System.out.println("frame removed from the virtual space");
	}
