...
./imageTiler.py ~/coadd_gal_AIT.fits ./coadd_AIT_neighbor -f -astropy -ts=500 -tl=6 -tileprefix=tile- -idprefix=coadd_AIT -layer=SceneKsSpace -minvalue=-10385.527 -maxvalue=50703.176
