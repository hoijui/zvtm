...
do
	...
	do
	    ...
	    ssh wild@192.168.2.$startIp -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no "export DISPLAY=:0 && cd /home2/wild/workspace/zvtm/zraildar/trunk && java -XX:+DoEscapeAnalysis -XX:+UseConcMarkSweepGC -Djava.net.preferIPv4Stack=true -Djgroups.bind_addr="\"192.168.2.$startIp\"" -Xmx4096M -Xms2048M -Dcom.sun.media.jai.disableMediaLib=true -cp $JARS fr.inria.zvtm.cluster.SlaveApp -n JSkyFitsViewer -b $SLAVENUM -wb $BLOCKNB -f -a $*" &
