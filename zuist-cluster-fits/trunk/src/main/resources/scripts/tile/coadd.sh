...
./imageTiler.py ~/coadd_gal_TAN.fits ./coadd_TAN_neighbor -f -astropy -ts=500 -tl=6 -tileprefix=tile- -idprefix=coadd_TAN -layer=SceneKsSpace -minvalue=-10626.094 -maxvalue=49248.715 -shrink
