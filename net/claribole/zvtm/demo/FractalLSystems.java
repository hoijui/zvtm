 ...
 *
 * $Id: FractalLSystems.java,v 1.5 2005/08/18 18:05:59 epietrig Exp $
 */ 
...
public class FractalLSystems extends FractalDemo {
	...
	for (int i=0;i<args.length;i++){
		...
		if (args[i].startsWith("-N") && args[i].length() > 2){
		    ...
		    System.out.println("java [classpath_options] net.claribole.zvtm.demo.FractalLSystems [options]");
		    System.out.println();
