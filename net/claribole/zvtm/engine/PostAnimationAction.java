...
public interface PostAnimationAction {
     ...
     *@param dimension what dimension of the object was animated, one of AnimManager.{GL_TRANS, GL_SZ, GL_ROT, GL_COLOR, GL_CTRL, CA_TRANS, CA_ALT, CA_BOTH, LS_MM, LS_RD, LS_BOTH} 
     */
