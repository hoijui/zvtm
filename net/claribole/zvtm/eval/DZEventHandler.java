 ...
 *
 * $Id: DZEventHandler.java,v 1.2 2006/05/26 14:51:48 epietrig Exp $
 */
...
class DZEventHandler extends WorldTaskEventHandler {

    DZEventHandler(ZLWorldTask appli){
	super(appli);
    }
	...
	application.dzoomIn(lastVX, lastVY);
    }
	...
	lastVX = v.getMouse().vx;
	lastVY = v.getMouse().vy;
 	application.dzoomOut(jpx, jpy, lastVX, lastVY);
    }
