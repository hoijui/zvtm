/*   FILE: ZLWorldTaskMapManager.java
 *   DATE OF CREATION:  Thu Jan 12 10:55:11 2006
...
public class ZLWorldTaskMapManager implements Runnable {
    ...
    ZLWorldTaskMapManager(MapApplication app, VirtualSpaceManager vsm, VirtualSpace vs, Camera c, View v){
	...
	vsm.addGlyph(mainMap, ZLWorldTask.mainVSname);
	vs.atBottom(mainMap);
	...
	if (maps[mapIndex] == null){
	    ...
	    vsm.addGlyph(maps[mapIndex], ZLWorldTask.mainVSname);
