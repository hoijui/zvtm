 ...
 *
 * $Id: AbstractTV2DEventHandler.java,v 1.6 2006/05/27 09:53:04 epietrig Exp $
 */ 
...
class AbstractTV2DEventHandler implements ViewEventHandler, ComponentListener {
    ...
    AbstractTV2DEventHandler(AbstractTrajectoryViewer2D appli){
	application = appli;
    }
	...
	if ((jpx-AbstractTrajectoryViewer2D.LENS_R1) < 0){
	    jpx = AbstractTrajectoryViewer2D.LENS_R1;
	    cursorNearBorder = true;
	}
	else if ((jpx+AbstractTrajectoryViewer2D.LENS_R1) > application.panelWidth){
	    jpx = application.panelWidth - AbstractTrajectoryViewer2D.LENS_R1;
	    cursorNearBorder = true;
	}
	else {
	    cursorNearBorder = false;
	}
	if ((jpy-AbstractTrajectoryViewer2D.LENS_R1) < 0){
	    jpy = AbstractTrajectoryViewer2D.LENS_R1;
	    cursorNearBorder = true;
	}
	else if ((jpy+AbstractTrajectoryViewer2D.LENS_R1) > application.panelHeight){
	    jpy = application.panelHeight - AbstractTrajectoryViewer2D.LENS_R1;
	    cursorNearBorder = true;
	}
