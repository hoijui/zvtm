/*   FILE: AbstractTaskZLEventHandler.java
 ...
 *
 * $Id: AbstractTaskZLEventHandler.java,v 1.17 2006/06/06 09:00:33 epietrig Exp $
 */
...
class AbstractTaskZLEventHandler extends AbstractTaskEventHandler {

    boolean cameraStickedToMouse = false;

    AbstractTaskZLEventHandler(ZLAbstractTask appli){
	super(appli);
    }
