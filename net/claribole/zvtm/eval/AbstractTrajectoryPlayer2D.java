/*   FILE: AbstractTrajectoryPlayer2D.java
 ...
 *
 * $Id: AbstractTrajectoryPlayer2D.java,v 1.7 2006/06/02 12:17:21 epietrig Exp $
 */ 
...
public class AbstractTrajectoryPlayer2D implements Runnable {
    ...
    public AbstractTrajectoryPlayer2D(AbstractTrajectoryViewer2D app){
	...
	while (runView == me){
	    ...
	    try {
		runView.sleep(AbstractTrajectoryViewer2D.TIME_STEP);
	    }
