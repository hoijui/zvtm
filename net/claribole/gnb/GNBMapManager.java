/*   FILE: GNBMapManager.java
 *   DATE OF CREATION:  Mon Oct 23 09:42:11 2006
...
public class GNBMapManager implements Runnable {
    ...
    GNBMapManager(GeonamesBrowser app, VirtualSpaceManager vsm, VirtualSpace vs, Camera c, View v){
	...
	vsm.addGlyph(mainMap, GeonamesBrowser.mapSpaceName);
	vs.atBottom(mainMap);
    }
	...
	if (maps[mapIndex] == null){
	    ...
	    vsm.addGlyph(maps[mapIndex], GeonamesBrowser.mapSpaceName);
