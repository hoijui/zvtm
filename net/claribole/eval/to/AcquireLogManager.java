...
// 	    bwc.flush();
    ...
    boolean validTarget(long cursorx, long cursory){
	return (Math.sqrt(Math.pow(cursorx-application.mCamera.posx,2)+Math.pow(cursory-application.mCamera.posy,2)) <= selectionRegionHSize) &&
