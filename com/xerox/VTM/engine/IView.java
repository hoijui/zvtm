 ...
 *   MODIF:              Tue Oct 12 09:15:16 2004 by Emmanuel Pietriga
...
public class IView extends View implements InternalFrameListener,KeyListener/*,MouseListener*/{
     ...
     */
    public IView(Vector v,String t,int panelWidth,int panelHeight,boolean bar,boolean visible,VirtualSpaceManager vsm,IViewContainer i,Integer layer){
	ivc=i;
     ...
     */
    public IView(Vector v,String t,int panelWidth,int panelHeight,boolean bar,boolean visible,VirtualSpaceManager vsm,IViewContainer i,JMenuBar mnb,Integer layer){
	ivc=i;
	frame=new JInternalFrame(t,true,true,true,true);
	frame.setDefaultCloseOperation(WindowConstants.DO_NOTHING_ON_CLOSE);
