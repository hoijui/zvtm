 ...
 *
 * $Id: VSlice.java,v 1.9 2006/03/17 17:45:23 epietrig Exp $
 */
...
public class VSlice extends Glyph implements Cloneable {
    ...
    /**set slice orientation (absolute)<br>slice orientation in virtual space (interpreted as the orientation of the segment linking the vertex that is not an arc endpoint to the middle of the arc)*/
    ...
    /**returns a clone of this object - not yet implemented for VSlice*/
    public Object clone(){
	//XXX: TBW
	return null;
    }
