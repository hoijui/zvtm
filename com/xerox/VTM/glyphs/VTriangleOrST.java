 ...
 *
 * $Id: VTriangleOrST.java,v 1.7 2006/03/17 17:45:23 epietrig Exp $
 */
...
public class VTriangleOrST extends VTriangleOr implements Transparent,Cloneable {
     ...
     */
    public VTriangleOrST(long x,long y,float z,long h,Color c,float or){
	super(x,y,z,h,c,or);
	acST=AlphaComposite.getInstance(AlphaComposite.SRC_OVER,alpha);  //transparency set to 0.5
    }
