...
public class SVGReader {
    ...
    public static String _polyline="polyline";
    public static String _line="line";
    public static String _rect="rect";
    ...
    */
	...
	if (ss != null){
	    if ((border=ss.getBorderColor())==null){border=Color.black;}
	}
	else if (ctx!=null && ctx.getBorderColor()!=null){
	    border=ctx.getBorderColor();
	}
	LongPoint lp1,lp2;
