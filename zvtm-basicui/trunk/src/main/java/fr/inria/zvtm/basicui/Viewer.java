...
public class Viewer {
    ...
    void populate(){
        mSpace.addGlyph(new VCircle(0,0,0,40,Color.RED));
        mSpace.addGlyph(new VText(0,40,10,Color.BLACK,"Hello World",VText.TEXT_ANCHOR_MIDDLE));
    }
...
class Overlay implements ViewListener {
    ...
    void showAbout(){
        if (!showingAbout){
            ...
            ildaLogo = new RImage(200, -40, 0, (new ImageIcon(this.getClass().getResource(Config.INSITU_LOGO_PATH))).getImage(), 1.0f);
