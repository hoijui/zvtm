...
# Based upon Mapnik's generate_tiles.py
# Modifications : Emmanuel Pietriga (emmanuel.pietriga@inria.fr)
        ...
        while True:
            ...
            if bytes == 126:
                ...
                if md5sum == EMPTY_SEA_TILE_512:
                    empty = " Empty Sea Tile "
                    os.rename(tile_uri, "%s.sea.png" % (tile_uri[:-4]))
                elif md5sum == EMPTY_LAND_TILE_512:
                    empty = " Empty Land Tile "
                    os.rename(tile_uri, "%s.lnd.png" % (tile_uri[:-4]))
                else:
                    empty = " Empty Unknown Tile "
